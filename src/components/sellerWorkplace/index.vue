                ...
                <a-card title="待办事项">
                    <a-row :gutter="20">
                        <a-col :md="6" :sm="12" :xs="24">
                            <head-info title="新客户" :content="todo.newCustom || 0" style="background-color:rgb(245,245,245)" />
                        </a-col>
                        <a-col :md="6" :sm="12" :xs="24">
                            <head-info title="待跟进" :content="todo.tofollow || 0" style="background-color:rgb(245,245,245)" />
                        </a-col>
                        <a-col :md="6" :sm="12" :xs="24">
                            <head-info title="跟进中" :content="todo.following || 0" style="background-color:rgb(245,245,245)" />
                        </a-col>
                        <a-col :md="6" :sm="12" :xs="24">
                            <head-info title="已成交" :content="todo.haddeal || 0" style="background-color:rgb(245,245,245)" />
                        </a-col>
                    </a-row>
                </a-card>

                <a-card title="个人业绩" style="margin-top:20px">
