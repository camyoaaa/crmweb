    ...
    <a-card :bordered="false">
                ...
                <a-row :gutter="48">
                    ...
                    <a-col :md="6" :sm="24">
                        <a-form-item label="联系方式">
                            <a-input v-model="queryParam.contact" placeholder="请输入QQ/微信/手机号" />
                        </a-form-item>
                    </a-col>
                    <a-col :md="6" :sm="24">
        ...
        <s-table ref="table" size="default" rowKey="cid" :columns="columns" :data="loadData" showPagination="auto" :pagination="pagination">
            ...
            <span slot="action" slot-scope="text, record">
                ...
                <a-button size="small" type="primary" @click="$refs.signOrder.open(record)">
                    签单
                </a-button>
                <a-button v-if="record.orderList.length > 0" size="small" type="primary" @click="$refs.ordermanage.open(record)">
                    订单管理
                </a-button>
            </span>
        </s-table>
