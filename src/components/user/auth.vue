            ...
            <div class="rygl_up">
                ...
                <div id="content">
                    <ul style="display:block;">
                        <div class="zhuce">
                            <input type="text" v-model="account" placeholder="请输入手机号" class="zhuce_num" />
                ...
                " class="zhuce_psd" />
                            ...
                            <input @click="mysubmit" type="button" :value="mode == 'login' ? '立即登录' : '立即注册'" class="zhuce_btn" style="cursor:pointer" />
                        </div>
                    </ul>
                </div>
            </div>
