    ...
    <div class="log_main" style="height:100%;padding-top:60px">
      ...
      <div class="rygl_up">
        <ul id="tab">
          ...
          <li :class="{ current: mode != 'login' }" @click="mode = 'login'">
            登录
          </li>
        </ul>
        <div id="content">
          <ul style="display:block;">
            <div class="zhuce">
              ...
              <input
                ...
                class="zhuce_psd"
              />
              <!-- <a-select v-if="mode == 'regist'"  defaultValue="none" v-model="role" style="width:100%;margin-bottom:20px">
                                <a-select-option value="none">选择角色</a-select-option>
                                ...
                                <a-select-option value="3">售后</a-select-option>
                            </a-select> -->
              <org-tree-select
                v-if="mode == 'regist'"
                single-select
                v-model="departmentPost"
