                ...
                <a-card title="待办事项">
                    <a-row>
                        <a-col :md="12" :sm="12" :xs="24">
                            <head-info title="待分配订单" :content="`${todo.toReviewPay} 单`" />
                        </a-col>
                        <a-col :md="12" :sm="12" :xs="24">
                            <head-info title="订单验收待审核" :content="`${todo.toReviewContract} 份`" />
                        </a-col>
                    </a-row>
                </a-card>

                <a-card title="售后情况" style="margin-top:20px">
                    ...
                    <a-row>
                        <a-col :md="12" :sm="12" :xs="24">
                            <head-info title="售后中" :content="`${dealData.dealCustom || 0} 个`" />
                        </a-col>
                        <a-col :md="12" :sm="12" :xs="24">
                            <head-info title="售后完成" :content="`${dealData.dealOrder || 0} 单`" />
                        </a-col>
                    </a-row>
                </a-card>
            </a-col>
