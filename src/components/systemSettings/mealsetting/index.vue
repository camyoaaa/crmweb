    ...
    <div :bordered="false">
        ...
        <s-table ref="table" size="default" rowKey="name" :columns="columns" :data="loadData" :alert="options.alert" :rowSelection="options.rowSelection" showPagination="auto" :pagination="pagination">
          ...
          " />
            ...
            <span slot="activity" slot-scope="text, record">
                <div v-if="!record.editing">{{ text }}</div>
                <a-input-number v-else :value="record.activity" @change="
            value => {
          ...
          " />
            ...
            <span slot="content" slot-scope="text, record">
                <business-select v-if="record.editing" :value="{ selects: record.content, labels: record.contentZn }" @change="
            ({ selects, labels }) => {
              mylog(selects, labels);
              record.content = selects;
              record.contentZn = labels;
            }
          " />
                <div v-else>
                    <a-tag v-for="(czn, index) in record.contentZn" :key="index">
                        {{ czn }}
                    </a-tag>
                </div>
            </span>
