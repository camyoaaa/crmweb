<template>
    <a-drawer placement="left" :width="800" @close="onClose" :visible="visible" :title="`更正合同-${contract.ctid}`" :destroyOnClose="true">
                ...
                <a-row :gutter="48">
                    ...
                    <a-col :span="12">
                        <a-form-model-item label="原合同截图">
                            <image-preview :src="contract.shot" style="width:102px;height:102px"></image-preview>
                        </a-form-model-item>
                    </a-col>
                    <a-col :span="12">
                        <a-form-model-item label="更新合同截图" prop="way">
