                        ...
                        <a-row :gutter="48">
                            ...
                            <a-col :span="8">
                                <a-form-item label="市/辖区">
                                    <city-select v-model="custom.city" :province="custom.province"></city-select>
                                </a-form-item>
                            </a-col>
                            <a-col :span="8">
                                <a-form-item label="区/县">
                                    <county-select v-model="custom.county" :province="custom.province" :city="custom.city" />
                                </a-form-item>
                            </a-col>
                            <a-col :span="16">
                            ...
                            <a-col :span="24">
                                <a-form-item label="接待备注">
                                    <a-input v-model="custom.remark" type="textarea" :rows="6"></a-input>
                                </a-form-item>
                            </a-col>
                        </a-row>
                    </a-form>
